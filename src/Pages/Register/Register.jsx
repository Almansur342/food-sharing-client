  ...
  return (
    <div className="bg-white flex max-w-md md:max-w-5xl lg:max-w-7xl p-1 md:p-10 lg:p-10">
       ...
       <div className="form-control">
          ...
          <div className="form-control">
            <button className="btn mt-6 bg-[#ffb606] text-white ext-base lg:text-lg mb-3 uppercase">create an account</button>
          </div>
          <Link className="flex justify-center text-xs lg:text-base" to="/login">Already have an account?<span className="text-[#ffb606] ml-1">Sign in.</span></Link>
        </form>
