  ...
  return (
    <div className="bg-white flex max-w-md md:max-w-5xl lg:max-w-7xl p-1 md:p-10 lg:p-10">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className=" space-y-3 rounded">
        ...
        <div className="form-control">
          <button className="btn mt-6 bg-[#ffb606] text-white text-base lg:text-lg mb-3 uppercase">Sign In</button>
        </div>
        <Link className="flex justify-center" to="/register">New here? <span className="text-[#ffb606] ml-1">Create an account</span></Link>
