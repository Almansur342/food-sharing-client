...
const ExtraSectionOne = () => {
  return (
    <div className="container px-4 mx-auto my-16">
      <h1 className="text-xl lg:text-3xl font-semibold"><span className="border-b-2 border-b-[#ffb606]">About</span> <span className="text-[#ffb606]">Be aHand</span></h1>
      <div className='flex flex-col lg:flex-row justify-between w-full items-center gap-4'>
        <div className='w-full lg:w-3/5'>
          <h3 className="text-base lg:text-xl font-medium mt-6 mb-2">Who We Are</h3>
        ...
        <div className='w-full mt-6 lg:mt-0 lg:w-2/5'>
           <img src={about} alt="" />
           <p className='font-medium text-left lg:text-center'><span className="text-[#ffb606] text-lg">Be aHand</span> Start Their Work With Small organizations In The Year 1990.Now Be aHand is world wide organizations.</p>
        </div>
      </div>
    </div>
  );
